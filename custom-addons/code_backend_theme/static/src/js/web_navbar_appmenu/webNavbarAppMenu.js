...
patch(NavBar.prototype, {
  ...
  openSidebar() {
    ...
    if (
      this.root.el.lastChild &&
      this.root.el.lastChild.nodeType === Node.ELEMENT_NODE
    ) {
      this.root.el.lastChild.style.display = "block";
    }
    document.getElementById("sidebar_panel").style.display = "block";
    if (
      this.topHeading.el &&
      this.topHeading.el.nodeType === Node.ELEMENT_NODE
    ) {
  ...
  closeSidebar() {
    ...
    document.getElementById("sidebar_panel").style.display = "none";
    if (
      this.topHeading.el &&
      this.topHeading.el.nodeType === Node.ELEMENT_NODE
    ) {
